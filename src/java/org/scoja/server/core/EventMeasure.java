 ...
 * This is an unsynchronized version.
 * See {@link SyncEventMeasure} for an synchronized version.
 */
public class EventMeasure {
    ...
    public void add(final EventMeasure other) {
        this.partialEvents += other.partialEvents;
