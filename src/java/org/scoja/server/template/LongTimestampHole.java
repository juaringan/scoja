...
public class LongTimestampHole extends DateHoleSkeleton {
    
    public LongTimestampHole(final String name, final int whichTimestamp) {
    ...
    public void writeTo(final PrintWriter out, final EventContext ectx) {
        try {
            DateUtils.formatLong(out, getCalendar(ectx));
