...
public class GeneralTZOffsetHole extends DateHoleSkeleton {

    public GeneralTZOffsetHole(final String name, final int whichTimestamp) {
    ...
    public void writeTo(final PrintWriter out, final EventContext ectx) {
        try {
            DateUtils.printGeneralTZ(out, getGMT(ectx));
