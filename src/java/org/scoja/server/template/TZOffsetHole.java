...
public class TZOffsetHole extends DateHoleSkeleton {

    public TZOffsetHole(final String name, final int whichTimestamp) {
    ...
    public void writeTo(final PrintWriter out, final EventContext ectx) {
        try {
            DateUtils.printRFC822TZ(out, getGMT(ectx));
