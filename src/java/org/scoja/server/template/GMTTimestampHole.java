...
public class GMTTimestampHole extends DateHoleSkeleton {
    
    public GMTTimestampHole(final String name, final int whichTimestamp) {
    ...
    public void writeTo(final PrintWriter out, final EventContext ectx) {
        try {
            DateUtils.formatGMT(out, getCalendar(ectx));
