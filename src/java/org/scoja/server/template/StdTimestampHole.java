...
public class StdTimestampHole extends DateHoleSkeleton {
    
    public StdTimestampHole(final String name, final int whichTimestamp) {
    ...
    public void writeTo(final PrintWriter out, final EventContext ectx) {
        try {
            DateUtils.formatStd(out, getCalendar(ectx));
