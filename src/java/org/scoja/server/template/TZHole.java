...
public class TZHole extends DateHoleSkeleton {

    public TZHole(final String name, final int whichTimestamp) {
    ...
    public void writeTo(final PrintWriter out, final EventContext ectx) {
        ...
        final String name = tz
            .getDisplayName(date.get(Calendar.DST_OFFSET) > 0, TimeZone.SHORT);
        out.print(getGMT(ectx));
    }
}
