...
public class VerbatimPart extends TemplatePartSkeleton {

    protected final String str;
    
    public VerbatimPart(final String str) {
        this.str = str;
    }
    ...
    public boolean equals(final Object other) {
        return (other instanceof VerbatimPart)
            && equals((VerbatimPart)other);
    }
    
    public boolean equals(final VerbatimPart other) {
