...
public class NumberDateHole extends DateHoleSkeleton {

    protected final int key;
    protected final int shift;

    public NumberDateHole(final String name, final int whichTimestamp,
                          final int key) {
