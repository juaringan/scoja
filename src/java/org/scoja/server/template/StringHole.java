...
public class StringHole extends VariableHoleSkeleton {

    protected final StringExpression strexpr;
    
    public StringHole(final String name,
    ...
    public void toFilename(final StringBuffer sb, final EventContext ectx) {
        sb.append(strexpr.eval(ectx).unqualified());
    }
    
    public String textFor(final EventContext ectx) {
        return strexpr.eval(ectx).unqualified();
    }
}
