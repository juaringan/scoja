...
public class ExceptionMessage extends EscapedHole {
    public ExceptionMessage() { super("exceptionmessage"); }
    ...
    public void format(final StringBuffer target, final LogRecord lr) {
        final Throwable error = lr.getThrown();
        if (error == null) return;
        appendEscaped(target, error.getMessage());
    }
}
